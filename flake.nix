...
# along with this program.  If not, see <https://www.gnu.org/licenses/>.
{
  ...
  inputs = rec {
    ...
    pythoneda-shared-code-requests-jupyterlab = {
      ...
      inputs.pythoneda-shared-pythonlang-domain.follows =
        "pythoneda-shared-pythonlang-domain";
      url = "github:pythoneda-shared-code-requests-def/jupyterlab/0.0.82";
    };
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        version = "0.0.11";
        sha256 = "18spwjyx0ggfh1cvv8xc3bpnsan89l7lki9yylp9yg45qz1vj4w8";
        pname = "${org}-${repo}";
        ...
        pythoneda-shared-artifact-code-events-infrastructure-for = { python
          ...
          in python.pkgs.buildPythonPackage rec {
            ...
            postInstall = with python.pkgs; ''
              ...
              for dep in ${pythoneda-shared-artifact-code-events} ${pythoneda-shared-code-requests-jupyterlab} ${pythoneda-shared-nix-flake-shared} ${pythoneda-shared-pythonlang-domain} ${pythoneda-shared-pythonlang-infrastructure}; do
